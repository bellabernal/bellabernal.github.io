...
function showCompletionPopup() {
  ...
  message.textContent = `Congratulations! You've successfully completed ${TARGET_REPS} shoulder shrugs. Your shoulders are now 0.001% less likely to seize up during your next 8-hour coding session!`;
